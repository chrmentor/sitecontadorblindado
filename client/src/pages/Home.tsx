          ...
          <div className="flex flex-col gap-6">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground">
                Proteja seu negócio com cláusulas blindadas e práticas estratégicas. Seja o Capitão Contador Blindado da sua empresa!
              </p>
            </div>
            ...
            <div className="flex gap-6 pt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">100% Proteção</span>
              </div>
              <div className="flex items-center gap-2">
                <Lock className="w-5 h-5 text-accent" />
                <span className="text-sm font-medium">Seguro Juridicamente</span>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Contadores enfrentam riscos legais todos os dias. Nós oferecemos as melhores práticas e cláusulas para proteger seu negócio.
            </p>
          </div>
